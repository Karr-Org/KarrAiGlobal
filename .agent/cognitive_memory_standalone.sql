-- ============================================================================
-- KARR AI COGNITIVE DIGITAL TWIN - STANDALONE MIGRATION
-- Version: 1.0
-- 
-- This is a STANDALONE migration that can be run directly in Supabase SQL Editor
-- It handles existing tables gracefully with IF NOT EXISTS and IF EXISTS checks
-- ============================================================================

-- ============================================================================
-- LAYER 2: EPISODIC MEMORY - Enhance Chat Sessions
-- ============================================================================
...
EXCEPTION WHEN OTHERS THEN 
    RAISE NOTICE 'Error adding columns to chat_sessions: %', SQLERRM;
END $$;
...
-- ============================================================================
-- LAYER 2: EPISODIC MEMORY - Enhance Chat Messages
-- ============================================================================
...
EXCEPTION WHEN OTHERS THEN 
    RAISE NOTICE 'Error adding columns to chat_messages: %', SQLERRM;
END $$;

-- Update session_id from chat_session_id if both exist
UPDATE chat_messages SET session_id = chat_session_id WHERE session_id IS NULL;
